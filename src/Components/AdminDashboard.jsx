            ...
            <div className="container mt-4">
                ...
                <div className="row">
                    <div className="col-lg mt-4">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title d-flex justify-content-between"><span>Top Products</span> <Link className='nav-link text-dark' to='/products' >See all</Link></h5>
                                <ul class="list-group mt-3 mb-3">
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        <div>
                                            <h6 class="my-0">Samsung Galaxy S21 Ultra</h6>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        <div>
                                            <h6 class="my-0">Nike Air Zoom Pegasus 38</h6>
                                            <small class="text-body-secondary">Sports & Outdoors</small>
                                        </div>
                                        <span class="text-body-secondary">$8</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        <div>
                                            <h6 class="my-0">Sony PlayStation 5</h6>
                                            <small class="text-body-secondary">Electronics</small>
                                        </div>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        <div>
                                            <h6 class="my-0">LEGO Star Wars Millennium Falcon</h6>
                                            <small class="text-body-secondary">Toys & Games</small>
                                        </div>
                                        <span class="text-body-secondary">$8</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        <div>
                                            <h6 class="my-0">KitchenAid Stand Mixer</h6>
                                            <small class="text-body-secondary">Home & Kitchen</small>
                                        </div>
                                        <span class="text-body-secondary">$5</span>
                                    </li>
                                </ul>
                            ...
                            <div className="card-body">
                                ...
                                <ul class="list-group mt-3 mb-3">
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        ...
                                        <div>
                                            <h6 class="my-0">Samsung Galaxy S21 Ultra has been delivered</h6>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        ...
                                        <div>
                                            <h6 class="my-0">Nike Air Zoom Pegasus 38 has been ordered</h6>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        ...
                                        <div>
                                            <h6 class="my-0">Samsung Galaxy S21 Ultra has been returned</h6>
                                            <small class="text-body-secondary">20 minutes ago</small>
                                        </div>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        ...
                                        <div>
                                            <h6 class="my-0">Nike Air Zoom Pegasus 38 has been deliverd</h6>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between lh-sm">
                                        ...
                                        <div>
                                            <h6 class="my-0">Nike Air Zoom Pegasus 30 has been returned</h6>
                                            <small class="text-body-secondary"> 30 minutes ago</small>
                                        </div>
                                    </li>
